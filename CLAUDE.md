...
ryo run_module multi/handler --option LHOST=10.0.0.1 --option LPORT=4444 --timeout 60  # --timeout: seconds to poll console output (default 15 / config [default] timeout)
ryo get_jobs
